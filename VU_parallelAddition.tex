...
\textcolor{red}{NUTNOST REDUNDANCE, PREPSAT PODLE OPRAV}
\input{method_description.tex}


\chapter{Convergence}
\label{chap:convergence}
\textcolor{red}{UVOD KAPITOLY I K SEKCIM, ZAVISLOST NA HUSTYCH MNOZINACH}
...
\textcolor{red}{OBRAZKY KROKU ODOU FAZI}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     K O N E C   P R Á C E                                            %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

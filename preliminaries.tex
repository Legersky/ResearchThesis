...
$$
    \ZZ[\omega] =\left\{\sum_{i=0}^n a_i \omega^i : n\in\NN, a_i\in\ZZ \right\} \subset \QQ(\omega)\,.
$$
\end{defn}
...
The following lemma summarises basic properties of the mapping $\odot_\omega$ -- factoring out an integer scalar, the identity element, the distributive law and a weaker form of asociativity.
\begin{lem}
\label{lem:multInZd}

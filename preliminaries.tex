...
e_{d-1}=\begin{pmatrix}
              ...
              \end{pmatrix}\,.             
$$
We remark that 1 in $e_i$ is on the $(i+1)$-st position for simplier later notation.
...
An important property of a companion matrix  -- being root of its own polynomial-- is necessary for proving a few properties of $\odot_\omega$.
\begin{lem}

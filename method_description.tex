...
The precise description of the semi-algorithm in a pseudocode is in Algorithm \ref{alg:weightCoefSet}. For better understanding, see Figures \ref{img:phase1img1}--\ref{img:phase1img13} in Appendix \ref{app:phase1} which illustrate the construction of the weight coefficients set $\Q$ for Eisenstein numeration system with a complex alphabet (its description is in Section \ref{sec:eisenstein}). 

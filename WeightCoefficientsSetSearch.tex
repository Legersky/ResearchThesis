...
Initialize the ring generator $\omega$, base $\beta$, alphabet $\A$ and input alphabet $\B$ by values obtained from \var{algForParallelAdd}. The parameter \var{method} characterizes the way of the choice from the possible candidates for the weight coefficients set.  
\end{method}
